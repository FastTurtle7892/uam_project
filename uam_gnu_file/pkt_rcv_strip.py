...
import pkt_rcv_strip_epy_block_0 as epy_block_0  # embedded python block
import sip
...
class pkt_rcv_strip(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "pkt_rcv_strip")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/jang/workspace/uam_gnu_file/experiment_result/experiment_Rx.tmp', True)
        ...
        self.msg_connect((self.pdu_tagged_stream_to_pdu_0, 'pdus'), (self.epy_block_0, 'msg_in'))
...
def main(top_block_cls=pkt_rcv_strip, options=None):
