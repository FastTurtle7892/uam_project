...
class xmt_rcv_switch(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_source_0 = uhd.usrp_source(
            ",".join(('serial=3218CC8', "recv_buff_size=12352,recv_frame_size=1544", "master_clock_rate=30.72e6")),
            uhd.stream_args(
                cpu_format="fc32",
                args='',
        ...
        self._tx_gain_range = Range(0, 1.00, 0.1, 1.00, 200)
